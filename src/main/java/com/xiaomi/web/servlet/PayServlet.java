...
public class PayServlet extends BaseServlet {
    ...
    public String pay(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        //按照商家要求拼字符串，将对应的参数给到地址
        String orderid = request.getParameter("orderid");//订单号
        String pd_FrpId = request.getParameter("pd_FrpId");//获取对应的银行id
        //支付金额，实际是从前端获得的，这里进行测试写成0.01
        ...
        // 第三方支付可以访问网址
        //回调地址
        String p8_Url = request.getContextPath() + "/callback";
        String p9_SAF = "";
        String pa_MP = "";
        ...
        response.sendRedirect(sb.toString());//引导用户去第三方支付平台
        return null;
    }
}
