...
<div class="panel panel-default" style="margin: 0 auto;width: 95%;">
			  ...
			  <ul class="pagination">
			    ...
			    <c:if test="${pageBean.pageNum==pageBean.pageCount }">
			     ...
			     <li><a href="${pageContext.request.contextPath }/goodsservlet?method=getGoodsListByTypeId&pageNum=${pageBean.pageNum+1}&pageSize=${pageBean.pageSize}&typeId=${typeId}" aria-label="Next"><span aria-hidden="true">»</span></a></li>
				  ...
				  <input id="pnself" type="text" name="pnself"/>页<a class="btn btn-default" onclick="click1()">跳转</a>
		  </ul>
		</nav>
		</c:if>
   	</div>
   ...
   <script type="text/javascript">
	   function click1() {
           var pnself = document.getElementById("pnself").value;
           location.href="${pageContext.request.contextPath }/goodsservlet?method=getGoodsListByTypeId&pageNum="+pnself+"&pageSize=${pageBean.pageSize}&typeId=${typeId}";
       }
   </script>
</body>
</html>