...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<ul id="top_right" class="collapse navbar-collapse nav navbar-nav navbar-right"	style="margin-right: 20px;">
			...
			<li>
				<a href="${pageContext.request.contextPath}/admin/userservlet?method=loginout" onclick="return confirm('确定退出吗？')">
		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/goodstypeservlet?method=showGoodsType");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/addGoodsType.jsp");
				})
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/goodsservlet?method=getGoodsList");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","addGoods.jsp");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/orderservlet?method=getAllOrder");
				})
			</script>
