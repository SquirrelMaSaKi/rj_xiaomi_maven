				  ...
				  <div class="panel-body">	 
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<tr>
							...
							<td colspan="3">
								<div class="input-group" style="width: 200px;">
							      <input type="text" class="form-control"  name="price" value="1"><!--金额为1分钱，这里注意应该从后端数据中获取，为了演示则改为1分钱-->
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control" name="body" value="rj_xiaomi" readonly="readonly">
							<!-- 设置 程序回传到的链接地址 -->
							<input type="hidden" class="form-control" name="url" value="http://localhost:8080/rj_xiaomi/wxcallback">
							</td>
						</tr>
